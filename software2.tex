	 ...
	 \item \textbf{binary} compatibility is \textbf{NOT} garantueed among generations.		 
      ...
      \begin{table}[H]
         \begin{center}
            ...
            \end{tabular}
         \end{center}
         \caption{\small{Some of the recent CUDA architectures (10/31/2025)}}
      \end{table}
\end{frame}
...
\begin{frame}
   \frametitle{Links}
	 ...
	 \item \href{https://docs.nvidia.com/cuda/cuda-c-programming-guide/index.html}{CUDA \CC\, Programming Guide Release $13.0$ 
		 (10/31/25)}
